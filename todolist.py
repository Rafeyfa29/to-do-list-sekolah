...
class ModernTodoApp:
    def __init__(self, root):
        ...
        self.color_done = "#95A5A6" # Warna abu-abu untuk yang sudah selesai
        ...
        tk.Label(self.sidebar, text="INPUT TUGAS", fg="white", bg=self.color_sidebar,
                 font=("Verdana", 14, "bold")).pack(pady=(30, 20))
        ...
        # Tombol Tambah
        self.btn_tambah = tk.Button(self.sidebar, text=" SIMPAN TUGAS + ", command=self.tambah_tugas,
                                     bg=self.color_success, fg="white", font=("Arial", 10, "bold"),
        ...
        tk.Label(self.header_frame, text="Daftar Tugas & Deadline Saya", font=("Verdana", 16),
                 bg="white", fg="#2C3E50").pack(side="left", padx=20, pady=20)
        ...
        # Penambahan Tag Warna untuk baris yang selesai
        self.tree = ttk.Treeview(self.table_frame, columns=("judul", "detail", "deadline", "status"), show="headings")
        self.tree.heading("judul", text="Tugas")
        self.tree.heading("detail", text="Detail")
        self.tree.heading("deadline", text="Deadline")
        self.tree.heading("status", text="Status Urgensi")
        ...
        self.btn_selesai = tk.Button(self.action_frame, text=" Tandai Selesai ✅ ", command=self.tandai_selesai,
                                      bg=self.color_accent, fg="white", bd=0, padx=15, pady=8, font=("Arial", 9, "bold"), cursor="hand2")
        self.btn_selesai.pack(side="left", padx=5)

        self.btn_hapus = tk.Button(self.action_frame, text=" Hapus Tugas 🗑️ ", command=self.hapus_tugas,
                                    bg=self.color_danger, fg="white", bd=0, padx=15, pady=8, font=("Arial", 9, "bold"), cursor="hand2")
    ...
    def tambah_tugas(self):
        ...
        try:
            ...
            # Tambahkan status 'selesai': False sebagai default
    ...
    def tandai_selesai(self):
        ...
        # Ubah status selesai menjadi True
        self.tugas_list[index]["selesai"] = True
        self.simpan_data()
        self.tampilkan_data()
        messagebox.showinfo("Mantap!", "Selamat! Satu tugas sudah selesai dikerjakan.")
    ...
    def cek_reminder(self):
        # Hanya ingatkan tugas yang BELUM selesai
        mendesak = [t['judul'] for t in self.tugas_list 
                    if not t.get("selesai") and 0 <= (datetime.strptime(t['deadline'], "%Y-%m-%d").date() - datetime.now().date()).days <= 3]
        
        if mendesak:
            messagebox.showwarning("REMINDER", "Ada tugas mendesak yang belum selesai:\n\n" + "\n".join(["- " + j for j in mendesak]))
